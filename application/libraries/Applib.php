...
class AppLib {
    ...
    static function _yearly_projects($year,$month){
        $query = "SELECT * FROM fx_projects WHERE MONTH(date_created) = '$month' AND YEAR(date_created) = '$year'";
    ...
    static function _yearly_expenses($year,$month){
        $total = 0;
        $query = "SELECT * FROM fx_expenses WHERE MONTH(expense_date) = '$month' AND YEAR(expense_date) = '$year'";
