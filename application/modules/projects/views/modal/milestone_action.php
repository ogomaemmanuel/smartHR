...
.datepicker{z-index:1151 !important;}
	...
	<?php $attributes = array('class' => 'bs-example form-horizontal');
		...
		<button type="submit" class="btn btn-success"><?=lang('add_milestone')?></button>
		</form>
		</div>
	</div>
...
<div class="modal-dialog">
	<div class="modal-content">
		...
		<div class="modal-body">
				...
				<label class="col-lg-4 control-label"><?=lang('start_date')?></label>
				<div class="col-lg-8">
					<input type="text" class="datepicker-input form-control" value="<?=strftime(config_item('date_format'), strtotime($m->start_date));?>" name="start_date" data-date-format="<?=config_item('date_picker_format');?>" >
				</div>
				</div>
				...
				<label class="col-lg-4 control-label"><?=lang('due_date')?></label>
				<div class="col-lg-8">
					<input type="text" class="datepicker-input form-control" value="<?=strftime(config_item('date_format'), strtotime($m->due_date));?>" name="due_date" data-date-format="<?=config_item('date_picker_format');?>" >
				</div>
				</div>
