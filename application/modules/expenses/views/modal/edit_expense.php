...
<div class="modal-dialog">
	<div class="modal-content">
		...
		<?php $attributes = array('class' => 'bs-example form-horizontal'); echo form_open_multipart(base_url().'expenses/edit',$attributes); ?>
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<div class="col-lg-3">
						<input type="file" class="filestyle" data-buttonText="<?=lang('choose_file')?>" data-icon="false" data-classButton="btn btn-default" data-classInput="form-control inline" name="receipt">
					</div>
				</div>
			</div>
