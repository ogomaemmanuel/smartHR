...
$chat_qry      =  "SELECT ad.*,u.* 
                   FROM fx_users u  
				   left join fx_account_details as ad on ad.user_id = u.id
			...
			<a href="javascript:;">
				<div class="list-item">
					<div class="list-left">
						...
						<?php }else{ ?>
						<img width="38" src="<?=base_url()?>assets/avatar/<?=Applib::profile_info($chat_user->user_id)->avatar?>" class="avatar">
						<?php } ?>
					 </div>
					<div class="list-body">
