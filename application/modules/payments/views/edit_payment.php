		...
		<div class="col-sm-12">
			<div class="panel panel-white">
				...
				<div class="panel-body">
					<?php $attributes = array('class' => 'bs-example form-horizontal'); echo form_open(base_url().'payments/edit',$attributes); ?>
						...
						<div class="form-group">
							...
							<div class="col-lg-4">
								<input class="datepicker-input form-control" type="text" value="<?=strftime(config_item('date_format'), strtotime($i->payment_date));?>" name="payment_date" data-date-format="<?=config_item('date_picker_format');?>" >
							</div>
						</div>
						<div class="form-group">
						...
						<div class="text-center m-t-30">
							<button type="submit" class="btn btn-lg btn-primary"> <?=lang('save_changes')?></button>
						</div>
					</form>
				</div>
			</div>
