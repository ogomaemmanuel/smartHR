<div class="modal-dialog">
	<div class="modal-content">
		...
		<?php $attributes = array('class' => 'bs-example form-horizontal'); echo form_open(base_url().'items/save_task',$attributes); ?>
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<div class="col-lg-8">
						<textarea name="description" class="form-control ta" placeholder="<?=lang('description')?>" required></textarea>
					</div>
				</div>
			</div>
			<div class="modal-footer"> <a href="#" class="btn btn-danger" data-dismiss="modal"><?=lang('close')?></a>
				<button type="submit" class="btn btn-success"><?=lang('save_as_template')?></button>
			</div>
		</form>
	</div>
</div>