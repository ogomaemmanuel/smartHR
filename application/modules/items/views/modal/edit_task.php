<div class="modal-dialog">
	<div class="modal-content">
		...
		<?php $task = Item::view_task($id); $attributes = array('class' => 'bs-example form-horizontal'); echo form_open(base_url().'items/edit_task',$attributes); ?>
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<div class="col-lg-8">
						<textarea name="description" class="form-control ta" required><?=$task->task_desc?></textarea>
					</div>
				</div>
			</div>
