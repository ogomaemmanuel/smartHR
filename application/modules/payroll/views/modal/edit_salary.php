		...
		<div class="modal-body">
			<?php $attributes = array('class' => 'form-horizontal'); echo form_open(base_url().'payroll/save_salary',$attributes); ?>
				<div class="form-group">
					...
					<div class="col-md-3"> 
						<button type="submit" class="btn btn-success btn-md"> Save New Salary </button>
					</div>
				</div> 
			</form>
			<hr>
			...
			<?php
			$previous_salary = $this->db->query("select * from fx_salary where user_id = ".$user_id." order by id desc")->result_array();
