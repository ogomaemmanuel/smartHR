<div class="row">
    ...
    <div class="col-lg-12">
        ...
        $css = read_file('./assets/css/style.css');
        ?>
        <section class="panel panel-default">
            <header class="panel-heading font-bold"><i class="fa fa-cogs"></i> Custom CSS</header>
            <div class="panel-body">
                <?php
                if (!is_really_writable('./assets/css/style.css'))
                {
                    echo "CSS file ./assets/css/style.css not writable";
                }
                ?>
            ...
            <div class="panel-footer">
                <div class="text-center">
                    <button id="saveeditor" class="btn btn-success"><?=lang('save_changes')?></button>
                </div>
            </div>
        </section>
    </div>
