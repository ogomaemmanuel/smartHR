		...
		<div class="tab-content tab-content-fix">
			<div class="tab-pane fade in active" id="tab-admin">
				<div class="table-responsive">
					<table id="menu-admin" class="table table-striped table-bordered custom-table m-b-0 sorted_table">
						<thead>
							<tr>
								<th></th>
								<th class="col-xs-2"><?=lang('icon')?></th>
								<th class="col-xs-8"><?=lang('menu')?></th>
								<th class="col-xs-2 text-center"><?=lang('visible')?></th>
							</tr>
						</thead>
						<tbody>
			...
			<div class="tab-pane fade in" id="tab-staff">
				<div class="table-responsive">
					<table id="menu-staff" class="table table-striped table-bordered custom-table m-b-0 sorted_table">
						<thead>
							<tr>
								<th></th>
								<th class="col-xs-2"><?=lang('icon')?></th>
								...
								<th class="col-xs-2 text-center"><?=lang('options')?></th>
							</tr>
						</thead>
						<tbody>
			...
			<div class="tab-pane fade in" id="tab-client">
				<div class="table-responsive">
					<table id="menu-client" class="table table-striped table-bordered custom-table m-b-0 sorted_table">
						<thead>
							<tr>
								<th></th>
								<th class="col-xs-2"><?=lang('icon')?></th>
