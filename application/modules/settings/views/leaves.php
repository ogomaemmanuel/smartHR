		...
		<div class="panel panel-table">
			...
			<div class="panel-body"> 
				<div class="table-responsive">
				   <?php
					$leave_res = $this->db->query("select * from fx_leave_types where status = 0")->result_array();
				   ?>
				...
				<div class="panel-body">
					<div class="tab-pane fade in active" id="tab-english">
						<div class="form-group">
							...
							<div class="col-lg-5">
								<input type="text" name="leave_type" class="form-control" id="leave_type" value="" required>
							</div>
						</div>
						<div class="form-group">
							<label class="col-lg-3 control-label"><?='Leave Days'?> <span class="text-danger">*</span></label>
							<div class="col-lg-5">
								<select class="select2-option" style="width:210px" id="leave_days" name="leave_days" required>
								<?php for($i = 1;$i <= 30; $i++ ){ ?>
						...
						<div class="text-center m-t-30">
							...
							<button type="submit" class="btn btn-primary l_type_save_btn"><?='Save'?></button>
