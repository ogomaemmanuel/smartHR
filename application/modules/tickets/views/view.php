...
<!--Start -->
        ...
        <?php if (User::is_admin()) { ?>
                                <a href="<?=base_url()?>tickets/delete/<?=$info->id?>" class="btn btn-sm btn-danger pull-right" data-toggle="ajaxModal">
...
img { max-width: 100%; height: auto; }
                            ...
                            <div class="col-sm-5 task-chat-view ticket_body">
