<div class="content">
	...
	<div class="row">
		<div class="col-lg-6">
			...
			<div class="panel">
				<div class="panel-heading">
					<h6 class="panel-title"><?=lang('change_email')?></h6>
				</div>
				<div class="panel-body">
					<?php
					$attributes = array('class' => 'bs-example');
					echo form_open(base_url().'auth/change_email',$attributes); ?>
						...
						<div class="form-group">
							<label><?=lang('current_email')?></label>
						...
						<div class="form-group">
							<label><?=lang('new_email')?></label>
							<input type="email" class="form-control" name="email" placeholder="<?=lang('new_email')?>" required>
						</div>
						<button type="submit" class="btn btn-success"><?=lang('change_email')?></button>
					</form>
					<!-- /profile form -->
				</div>
			</div>
