            ...
            <?php } ?>
                        ...
                        <div class="col-sm-4">
                            <?php if ($estimate->client != 0) { ?>
                                ...
                                <a href="<?=base_url()?>fopdf/estimate/<?=$estimate->est_id?>" class="btn btn-sm btn-primary pull-right"><i class="fa fa-file-pdf-o"></i> <?=lang('pdf')?></a>
                                <?php elseif(config_item('pdf_engine') == 'mpdf') : ?>
                                <a href="<?=base_url()?>estimates/pdf/<?=$estimate->est_id?>" class="btn btn-sm btn-primary pull-right"><i class="fa fa-file-pdf-o"></i> <?=lang('pdf')?></a>
                                <?php endif; ?>
                            <?php } ?>
