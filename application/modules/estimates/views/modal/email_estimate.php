<div class="modal-dialog">
	<div class="modal-content">
		...
		<?php $attributes = array('class' => 'bs-example form-horizontal'); echo form_open(base_url().'estimates/email',$attributes); ?>
			...
			<div class="modal-footer"> <a href="#" class="btn btn-danger" data-dismiss="modal"><?=lang('close')?></a> 
				<button type="submit" class="submit btn btn-success"><?=lang('email_estimate')?></button>
			</div>
		</form>
	</div>
