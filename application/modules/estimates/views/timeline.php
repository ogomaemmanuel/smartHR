<div class="header-fixed clearfix hidden-print">
	<div class="row">
		<div class="col-sm-7">
			<?php $e = Estimate::view_estimate($id); ?>
			<div class="btn-group">
				<a href="<?=base_url()?>estimates/view/<?=$e->est_id?>" data-original-title="<?=lang('view_details')?>" data-toggle="tooltip" data-placement="bottom" class="btn btn-success btn-sm">
		...
		<div class="col-sm-4 pull-right">
			...
			<a href="<?=base_url()?>fopdf/estimate/<?=$e->est_id?>" class="btn btn-sm btn-primary pull-right"><i class="fa fa-file-pdf-o"></i> <?=lang('pdf')?></a>
			<?php elseif(config_item('pdf_engine') == 'mpdf') : ?>
			<a href="<?=base_url()?>estimates/pdf/<?=$e->est_id?>" class="btn btn-sm btn-primary pull-right"><i class="fa fa-file-pdf-o"></i> <?=lang('pdf')?></a>
			<?php endif; ?>
			<?php } ?>
		</div>
	</div>
